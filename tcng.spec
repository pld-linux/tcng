...
tcng jest od nowa zaprojektowaną architekturą kontroli ruchu dla
Linuksa. W pierwszej fazie język konfiguracji będzie usprawniony. W
drugiej fazie komponenty jądra będą generowane bezpośrednio poprzez
narzędzia konfigurujące. Wszystko to pod każdym względem jest w pełni
kompatybilne z istniejącą infrastrukturą kontroli ruchu.
...
tcsim łączy w sobie oryginalny kod kontroli ruchu z jądra Linuksa wraz
z kodem z przestrzeni użytkownika, a mianowicie narzędziem tc oraz
dodatkowo dodaje część umożliwiającą komunikację między nimi plus
silnik symulacji.
